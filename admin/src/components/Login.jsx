      ...
      <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
        ...
        <form onSubmit={onSubmitHandler}>
            <div className='mb-3 min-w-72'>
                <p className='text-sm font-medium text-medium text-gray-700 mb-2'>Email Address</p>
            ...
            <div className='mb-3 min-w-72'>
                <p className='text-sm font-medium text-medium text-gray-700 mb-2'>Password</p>
